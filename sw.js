...
const FILES = [
  ...
  './js/main.js', './js/fparms.js', './js/particles.js', './assets/audio/sfx.mp3', './assets/audio/sfx.json', './js/game.js', './js/world.js', './js/mapmesh.js', './js/agent.js', './js/character.js', './js/bot.js',
